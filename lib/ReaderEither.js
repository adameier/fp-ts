...
exports.ap = 
/*#__PURE__*/
Apply_1.apComposition(R.applicativeReader, E.applicativeEither);
/**
...
function getApplicativeReaderValidation(SE) {
    var ap = Apply_1.apComposition(R.applicativeReader, E.getApplicativeValidation(SE));
    return {
        URI: exports.URI,
        _E: undefined,
        map: map_,
 ...
 * @since 2.7.0
 */
exports.applicativeReaderEither = {
    URI: exports.URI,
    map: map_,
    ap: ap_,
    of: of
 ...
 * @since 2.7.0
 */
exports.monadThrowReaderEither = {
    URI: exports.URI,
    map: map_,
    ap: ap_,
    of: of,
