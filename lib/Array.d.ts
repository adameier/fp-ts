 ...
 * @since 3.0.0
 */
export declare const functorWithIndexArray: FunctorWithIndex1<URI, number>
/**
 * @since 3.0.0
 */
export declare const applyArray: Apply1<URI>
/**
 * @since 3.0.0
 */
export declare const applicativeArray: Applicative1<URI>
/**
 * @since 3.0.0
 */
export declare const monadArray: Monad1<URI>
/**
 * @since 3.0.0
 */
 ...
 * @since 3.0.0
 */
export declare const unfoldableArray: Unfoldable1<URI>
/**
 * @since 3.0.0
 */
export declare const compactableArray: Compactable1<URI>
/**
 * @since 3.0.0
 */
export declare const filterableArray: Filterable1<URI>
/**
 * @since 3.0.0
 */
export declare const filterableWithIndexArray: FilterableWithIndex1<URI, number>
/**
 * @since 3.0.0
 */
export declare const foldableArray: Foldable1<URI>
/**
 * @since 3.0.0
 */
export declare const foldableWithIndexArray: FoldableWithIndex1<URI, number>
/**
 * @since 3.0.0
 */
export declare const altArray: Alt1<URI>
/**
 * @since 3.0.0
 */
export declare const alternativeArray: Alternative1<URI>
/**
 * @since 3.0.0
 */
export declare const traversableArray: Traversable1<URI>
/**
 * @since 3.0.0
 */
export declare const traversableWithIndexArray: TraversableWithIndex1<URI, number>
/**
 * @since 3.0.0
 */
export declare const extendArray: Extend1<URI>
/**
 * @since 3.0.0
 */
export declare const witherableArray: Witherable1<URI>
