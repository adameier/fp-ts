...
var map_ = function (ma, f) {
    return exports.isLeft(ma) ? ma : exports.right(f(ma.right));
};
...
var bimap_ = function (fea, f, g) {
    return exports.isLeft(fea) ? exports.left(f(fea.left)) : exports.right(g(fea.right));
};
var mapLeft_ = function (fea, f) {
    return exports.isLeft(fea) ? exports.left(f(fea.left)) : fea;
};
