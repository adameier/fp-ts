...
function getFilterable(M) {
    ...
    return __assign(__assign({}, getCompactable(M)), { map: exports.map,
        filter: filter,
        filterMap: filterMap,
        partition: partition,
...
function getWitherable(M) {
    ...
    return __assign(__assign({}, filterableEither), { traverse: exports.traverse,
        sequence: exports.sequence,
        reduce: exports.reduce,
        foldMap: exports.foldMap,
        reduceRight: exports.reduceRight,
