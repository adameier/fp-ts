...
function getWitherable(M) {
    ...
    var wither = function (F) {
        ...
        return function (f) { return function (ma) { return function_1.pipe(ma, traverseF(f), F.map(compact)); }; };
    };
    var wilt = function (F) {
        var traverseF = exports.traverse(F);
        return function (f) { return function (ma) { return function_1.pipe(ma, traverseF(f), F.map(separate)); }; };
    };
    return {
        URI: exports.URI,
        _E: undefined,
