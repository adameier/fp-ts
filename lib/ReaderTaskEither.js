...
function getReaderTaskValidation(S) {
    return {
        ...
        _E: undefined,
        map: exports.map,
        ap: Apply_1.apComposition(RT.applicativeReaderTask, Either_1.getValidation(S)),
        of: of,
