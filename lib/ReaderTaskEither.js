...
function getApplicativeReaderTaskValidation(A, SE) {
    var ap = Apply_1.apComposition(R.applicativeReader, TE.getApplicativeTaskValidation(A, SE));
    return {
        URI: exports.URI,
        _E: undefined,
        map: map_,
...
function getReaderTaskValidation(SE) {
    var applicativeReaderTaskValidation = getApplicativeReaderTaskValidation(T.applicativeTaskPar, SE);
