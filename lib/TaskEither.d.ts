 ...
 * @since 2.4.0
 */
export declare function fromEitherK<E, A extends ReadonlyArray<unknown>, B>(f: (...a: A) => Either<E, B>): (...a: A) => TaskEither<E, B>;
/**
 * @since 2.4.0
 */
 ...
 * @since 2.4.0
 */
export declare function fromIOEitherK<E, A extends ReadonlyArray<unknown>, B>(f: (...a: A) => IOEither<E, B>): (...a: A) => TaskEither<E, B>;
/**
 * @since 2.4.0
 */
 ...
 * @since 2.5.0
 */
export declare function tryCatchK<E, A extends ReadonlyArray<unknown>, B>(f: (...a: A) => Promise<B>, onRejected: (reason: unknown) => E): (...a: A) => TaskEither<E, B>;
/**
 * @since 2.0.0
 */
 ...
 * @since 3.0.0
 */
export declare const applicativeTaskEither: Applicative2<URI>;
/**
 * @since 2.0.0
 */
 ...
 * @since 2.6.0
 */
export declare const chainW: <D, A, B>(f: (a: A) => TaskEither<D, B>) => <E>(ma: TaskEither<E, A>) => TaskEither<E | D, B>;
/**
 * @since 2.6.1
 */
export declare const chainEitherKW: <D, A, B>(f: (a: A) => Either<D, B>) => <E>(ma: TaskEither<E, A>) => TaskEither<E | D, B>;
/**
 * @since 2.6.1
 */
export declare const chainIOEitherKW: <D, A, B>(f: (a: A) => IOEither<D, B>) => <E>(ma: TaskEither<E, A>) => TaskEither<E | D, B>;
/**
 * @since 2.0.0
 */
 ...
 * @since 2.0.0
 */
export declare const monadTaskEitherSeq: Monad2<URI> & Bifunctor2<URI> & Alt2<URI> & MonadTask2<URI> & MonadThrow2<URI>;
