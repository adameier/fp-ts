...
// instances
// -------------------------------------------------------------------------------------
var map_ = RNEA.functorNonEmptyArray.map;
var mapWithIndex_ = RNEA.functorWithIndexNonEmptyArray
    .mapWithIndex;
var ap_ = RNEA.applicativeNonEmptyArray.ap;
var chain_ = RNEA.monadNonEmptyArray.chain;
var extend_ = RNEA.comonadNonEmptyArray.extend;
var reduce_ = RNEA.foldableNonEmptyArray.reduce;
var foldMap_ = RNEA.foldableNonEmptyArray.foldMap;
var reduceRight_ = RNEA.foldableNonEmptyArray.reduceRight;
var traverse_ = RNEA.traversableNonEmptyArray.traverse;
var alt_ = RNEA.altNonEmptyArray.alt;
var reduceWithIndex_ = RNEA.foldableWithIndexNonEmptyArray
    .reduceWithIndex;
var foldMapWithIndex_ = RNEA.foldableWithIndexNonEmptyArray
    .foldMapWithIndex;
var reduceRightWithIndex_ = RNEA
    .foldableWithIndexNonEmptyArray.reduceRightWithIndex;
var traverseWithIndex_ = RNEA
    .traversableWithIndexNonEmptyArray.traverseWithIndex;
/**
 * @category instances
 * @since 2.0.0
 */
 ...
 * @since 2.7.0
 */
exports.functorWithIndexNonEmptyArray = {
    URI: exports.URI,
    map: map_,
 ...
 * @since 2.7.0
 */
exports.applicativeNonEmptyArray = {
    URI: exports.URI,
    map: map_,
    ap: ap_,
    of: exports.of
 ...
 * @since 2.7.0
 */
exports.foldableWithIndexNonEmptyArray = {
    URI: exports.URI,
    reduce: reduce_,
    foldMap: foldMap_,
    reduceRight: reduceRight_,
 ...
 * @since 2.7.0
 */
exports.traversableNonEmptyArray = {
    URI: exports.URI,
    map: map_,
    reduce: reduce_,
    foldMap: foldMap_,
 ...
 * @since 2.7.0
 */
exports.traversableWithIndexNonEmptyArray = {
    URI: exports.URI,
    map: map_,
    mapWithIndex: mapWithIndex_,
    reduce: reduce_,
