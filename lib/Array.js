 ...
 * @since 2.7.0
 */
exports.zero = RA.alternativeArray.zero;
// -------------------------------------------------------------------------------------
// instances
// -------------------------------------------------------------------------------------
var map_ = RA.monadArray.map;
var ap_ = RA.monadArray.ap;
var chain_ = RA.monadArray.chain;
var mapWithIndex_ = RA.functorWithIndexArray.mapWithIndex;
var filter_ = RA.filterableArray.filter;
var filterMap_ = RA.filterableArray.filterMap;
var partition_ = RA.filterableArray.partition;
var partitionMap_ = RA.filterableArray.partitionMap;
var filterWithIndex_ = RA.filterableWithIndexArray
    .filterWithIndex;
var filterMapWithIndex_ = RA.filterableWithIndexArray
    .filterMapWithIndex;
var partitionWithIndex_ = RA.filterableWithIndexArray
    .partitionWithIndex;
var partitionMapWithIndex_ = RA.filterableWithIndexArray
...
var alt_ = RA.alternativeArray.alt;
var reduceWithIndex_ = RA.foldableWithIndexArray.reduceWithIndex;
var foldMapWithIndex_ = RA.foldableWithIndexArray.foldMapWithIndex;
var reduceRightWithIndex_ = RA.foldableWithIndexArray.reduceRightWithIndex;
var traverseWithIndex_ = RA.traversableWithIndexArray
    .traverseWithIndex;
var extend_ = RA.extendArray.extend;
var wither_ = RA.witherableArray.wither;
var wilt_ = RA.witherableArray.wilt;
/**
 * @category instances
 * @since 2.0.0
 */
 ...
 * @since 2.7.0
 */
exports.filterableWithIndexArray = {
    URI: exports.URI,
    map: map_,
    mapWithIndex: mapWithIndex_,
    compact: exports.compact,
 ...
 * @since 2.7.0
 */
exports.foldableWithIndexArray = {
    URI: exports.URI,
    reduce: reduce_,
    foldMap: foldMap_,
    reduceRight: reduceRight_,
 ...
 * @since 2.7.0
 */
exports.traversableWithIndexArray = {
    URI: exports.URI,
    map: map_,
    mapWithIndex: mapWithIndex_,
    reduce: reduce_,
