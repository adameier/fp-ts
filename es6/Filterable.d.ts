 ...
 * @since 3.0.0
 */
export declare function filterComposition<F extends URIS, G extends URIS2, E>(F: Functor1<F>, G: Filterable2C<G, E>): <A>(predicate: Predicate<A>) => (fga: Kind<F, Kind2<G, E, A>>) => Kind<F, Kind2<G, E, A>>;
export declare function filterComposition<F extends URIS, G extends URIS>(F: Functor1<F>, G: Filterable1<G>): <A>(predicate: Predicate<A>) => (fga: Kind<F, Kind<G, A>>) => Kind<F, Kind<G, A>>;
export declare function filterComposition<F, G>(F: Functor<F>, G: Filterable<G>): <A>(predicate: Predicate<A>) => (fga: HKT<F, HKT<G, A>>) => HKT<F, HKT<G, A>>;
/**
 * @since 3.0.0
 */
export declare function filterMapComposition<F extends URIS, G extends URIS2, E>(F: Functor1<F>, G: Filterable2C<G, E>): <A, B>(f: (a: A) => Option<B>) => (fga: Kind<F, Kind2<G, E, A>>) => Kind<F, Kind2<G, E, B>>;
export declare function filterMapComposition<F extends URIS, G extends URIS>(F: Functor1<F>, G: Filterable1<G>): <A, B>(f: (a: A) => Option<B>) => (fga: Kind<F, Kind<G, A>>) => Kind<F, Kind<G, B>>;
export declare function filterMapComposition<F, G>(F: Functor<F>, G: Filterable<G>): <A, B>(f: (a: A) => Option<B>) => (fga: HKT<F, HKT<G, A>>) => HKT<F, HKT<G, B>>;
/**
 * @since 3.0.0
 */
export declare function partitionComposition<F extends URIS, G extends URIS2, E>(F: Functor1<F>, G: Filterable2C<G, E>): <A>(predicate: Predicate<A>) => (fga: Kind<F, Kind2<G, E, A>>) => Separated<Kind<F, Kind2<G, E, A>>, Kind<F, Kind2<G, E, A>>>;
export declare function partitionComposition<F extends URIS, G extends URIS>(F: Functor1<F>, G: Filterable1<G>): <A>(predicate: Predicate<A>) => (fga: Kind<F, Kind<G, A>>) => Separated<Kind<F, Kind<G, A>>, Kind<F, Kind<G, A>>>;
export declare function partitionComposition<F, G>(F: Functor<F>, G: Filterable<G>): <A>(predicate: Predicate<A>) => (fga: HKT<F, HKT<G, A>>) => Separated<HKT<F, HKT<G, A>>, HKT<F, HKT<G, A>>>;
/**
 * @since 3.0.0
 */
export declare function partitionMapComposition<F extends URIS, G extends URIS2, E>(F: Functor1<F>, G: Filterable2C<G, E>): <A, B, C>(f: (a: A) => Either<B, C>) => (fa: Kind<F, Kind2<G, E, A>>) => Separated<Kind<F, Kind2<G, E, B>>, Kind<F, Kind2<G, E, C>>>;
export declare function partitionMapComposition<F extends URIS, G extends URIS>(F: Functor1<F>, G: Filterable1<G>): <A, B, C>(f: (a: A) => Either<B, C>) => (fa: Kind<F, Kind<G, A>>) => Separated<Kind<F, Kind<G, B>>, Kind<F, Kind<G, C>>>;
export declare function partitionMapComposition<F, G>(F: Functor<F>, G: Filterable<G>): <A, B, C>(f: (a: A) => Either<B, C>) => (fa: HKT<F, HKT<G, A>>) => Separated<HKT<F, HKT<G, B>>, HKT<F, HKT<G, C>>>;
