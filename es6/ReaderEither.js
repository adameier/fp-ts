...
export function getApplicativeReaderValidation(SE) {
    var ap = apComposition(R.applicativeReader, E.getApplicativeValidation(SE));
    return {
        URI: URI,
        _E: undefined,
        map: map_,
 ...
 * @since 2.7.0
 */
export var functorReaderEither = {
    URI: URI,
    map: map_
};
/**
 ...
 * @since 2.7.0
 */
export var applicativeReaderEither = {
    URI: URI,
    map: map_,
    ap: ap_,
    of: of
 ...
 * @since 2.7.0
 */
export var bifunctorReaderEither = {
    URI: URI,
    bimap: bimap_,
    mapLeft: mapLeft_
};
 ...
 * @since 2.7.0
 */
export var monadThrowReaderEither = {
    URI: URI,
    map: map_,
    ap: ap_,
    of: of,
